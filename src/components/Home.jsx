    ...
    <>
      ...
      <section className="flex flex-col gap-16 px-32 z-10">
        <div className="flex justify-between items-center">
          <h1 className="font-bold text-8xl z-10">
            Hello, <br /> I am Daniel Bartolini
          </h1>
          <div
            style={mePic}
            className="rounded-full w-80 h-80 bg-mintCream box-border border-2 border-mintCream bg-no-repeat bg-cover"
          ></div>
        </div>
        <h3 className="text-5xl w-2/3">
